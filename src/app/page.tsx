...
<div className="flex items-center bg-white rounded-lg shadow-md p-2 mb-8">
  {/* Keyword input */}
  <div className="flex items-center flex-1 px-2">
    ...
    <input
      ...
      className="w-full px-4 py-3 border border-gray-400 text-gray-900 placeholder-gray-600 rounded-md"
    />
  </div>
  ...
  <button
        onClick={() => {}}
    className="ml-2 px-4 py-3 bg-blue-700 hover:bg-blue-800 text-white text-sm font-semibold rounded-md transition"
  >
    Search
  </button>
</div>
