...
import SearchForm from '@/components/SearchForm' // New Client Component
import NewsletterForm from '@/components/NewsletterForm'; // New Client Component
      ...
      <section className="relative -mt-12 z-10">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-2xl shadow-xl p-8 border">
            <SearchForm popularSearches={popularSearches} />
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-[#31C7FF]/10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-white rounded-2xl shadow-xl p-12">
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Never Miss a Premium Opportunity</h2>
