      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          <Link href="/" className="flex justify-center">
            <img className="h-12 w-auto" src="/img/logo.svg" alt="SixFigHires" />
          </Link>
          <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">
            Create your account
          </h2>
          <p className="mt-2 text-center text-sm text-gray-600">
            Join thousands of professionals finding six-figure opportunities
          </p>
        </div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSignup}>
            ...
            <div className="grid grid-cols-2 gap-3">
              <label className={`relative flex cursor-pointer rounded-lg border p-4 focus:outline-none ${
                ...
                <div className="flex flex-col">
                  ...
                  <span className="block text-sm text-gray-500">Find six-figure opportunities</span>
                </div>
              </label>
              ...
              <label className={`relative flex cursor-pointer rounded-lg border p-4 focus:outline-none ${
                ...
                />
                <div className="flex flex-col">
                  <span className="block text-sm font-medium text-gray-900">Employer</span>
                  <span className="block text-sm text-gray-500">Post premium jobs</span>
                </div>
              </label>
            </div>
          </div>
          ...
          <div className="flex items-center">
            ...
            />
            <label htmlFor="isNewsletterSubscriber" className="ml-2 block text-sm text-gray-700">
