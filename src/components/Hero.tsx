const Hero = () => {
  return (
<section x-data="{ mobileNavOpen: false }" className="bg-white">
  <nav className="flex justify-between p-6 px-4">
    ...
    <button x-on:click="mobileNavOpen = !mobileNavOpen" className="navbar-burger self-center xl:hidden">
  ...
  <div x-show="mobileNavOpen" className="navbar-menu fixed top-0 left-0 z-50 w-full h-full bg-coolGray-900 bg-opacity-50">
    <div className="fixed top-0 left-0 bottom-0 w-full w-4/6 max-w-xs bg-white">
      ...
      <button x-on:click="mobileNavOpen = !mobileNavOpen" className="navbar-close absolute top-5 p-4 right-3">
